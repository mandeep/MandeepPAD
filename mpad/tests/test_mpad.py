...
@pytest.fixture
def window(qtbot):
    """Text editor fixture to be passed to the tests."""
...
def test_window(window):
    """Test the window title and that the window icon is visible."""
...
def test_text_area(qtbot, window):
    """Test that the text is being inserted into the text area."""
...
def test_bars(window):
    """Test whether the widget contains a status bar and menu bar."""
    assert window.statusBar().isVisible()
    assert window.menuBar().isVisible()


def test_menu_bar(window):
    """Test whether the menu items appear on the menu bar."""
...
def test_new_file(qtbot, window):
    """Test the 'New File' item on the File submenu.
...
def test_open_file(qtbot, mock, window):
    """Test the 'Open File' item on the File submenu.
...
def test_save_file(qtbot, mock, window):
    """Test the 'Save File' item on the File submenu.
...
def test_print_file(qtbot, mock, window):
    """Test the 'Print' item on the File submenu.
...
def test_quit_application(qtbot, monkeypatch, window):
    """Test the 'Quit' item on the File submenu.
...
def test_undo_action(qtbot, window):
    """Test the 'Undo' item on the Edit submenu.
...
def test_redo_action(qtbot, window):
    """Test the 'Redo' item on the Edit submenu.
...
def test_delete_action(qtbot, window):
    """Test the 'Delete' item on the Edit submenu.
...
def test_font_dialog(qtbot, mock, window):
    """Test the 'Font' item on the Format submenu.
...
def test_text_search(qtbot, mock, window):
    """Test the 'Find Text' item on the Tools submenu.
...
def test_date(qtbot, window):
    """Test the 'Insert Date/Time' item on the Tools submenu.
...
def test_menu_bar_visibility(qtbot, window):
    """Test the 'Hide Menubar' item on the View submenu.

    Qtbot opens the view menu and selects the Hide Menubar item."""
...
def test_tool_bar_visibility(qtbot, window):
    """Test the 'Show Toolbar' item on the View submenu.

    Qtbot opens the view menu and selects the Show Toolbar item."""
    qtbot.mouseClick(window.view, Qt.LeftButton)
    qtbot.keyClick(window.view, Qt.Key_Down)
    qtbot.keyClick(window.view, Qt.Key_Down)
    qtbot.keyClick(window.view, Qt.Key_Enter)
...
def test_status_bar_visibility(qtbot, window):
    """Test the 'Hide Statusbar' item on the View submenu.

    Qtbot opens the view menu and selects the Hide Statusbar item."""
    qtbot.mouseClick(window.view, Qt.LeftButton)
    qtbot.keyClick(window.view, Qt.Key_Down)
    qtbot.keyClick(window.view, Qt.Key_Down)
    qtbot.keyClick(window.view, Qt.Key_Down)
...
def test_about(qtbot, mock, window):
    """Test the 'About' item on the Help submenu.
